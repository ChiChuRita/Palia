    ...
    <View style={styles.container}>
      ...
      health?.stepsYesterday != null ? (
        <View style={styles.contextRow}>
          {pemToday ? (
            <ContextChip text={t('today.pemToday')} emphasized />
          ) : null}
          {sleepHoursToday != null ? (
            <ContextChip
          ...
          {health?.hrvMs != null ? (
            <ContextChip
              text={t('today.hrv', { value: health.hrvMs.toString() })}
            />
          ) : null}
          {health?.stepsYesterday != null ? (
            <ContextChip
      ...
      {[1, 2, 3, 4, 5].map((i) => {
        ...
        return (
          <AnimatedDot
            ...
            size={dotSize}
            backgroundColor={
              isOn ? color : theme.backgroundElement
            }
            borderColor={
              isOn ? color : theme.backgroundSelected
            }
          />
        );
      })}
